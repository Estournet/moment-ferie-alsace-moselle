var moment = require("./moment-ferie-alsace-moselle");
...
assert.equal(y2013.saintEtienne().format("DD/MM/YYYY"), "26/12/2013")
...
assert.equal(y2014.saintEtienne().format("DD/MM/YYYY"), "26/12/2014")
assert.equal(y2014.vendrediSaint().format("DD/MM/YYYY"), "18/04/2014")
...
assert.equal(moment().saintEtienne(2015).format("DD/MM/YYYY"), "26/12/2015")
assert.equal(moment().vendrediSaint(2015).format("DD/MM/YYYY"), "03/04/2015")
